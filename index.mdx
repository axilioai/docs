...
Copy and paste this into your AI coding agent (Cursor, Claude, Codex, Windsurf,
or similar). It installs the Axilio CLI, loads Axilio's agent instructions,
guides you through secure authentication, and verifies the setup with a live
phone session before your agent builds a reusable workflow.

<Accordion title="Copy prompt" icon="copy">
